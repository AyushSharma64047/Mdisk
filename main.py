...
async def inline_handlers(_, event: Message):
    if event.text == '/start':
        return
    answers = f'**📂 Results For ➠ {event.text} \n\n▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰\n➠ Type Only Movie Name With Correct Spelling.✍️\n➠ In Second Attempt,For Movies Add Year And For Series Add Season.In Thrird Attempt Try Typing In CAPITAL LETTERS ONLY.For Better Result.🗓️\n▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱▰▱\n\n**'
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
						InlineKeyboardButton("Support", url="https://t.me/blackest_harbour"),
